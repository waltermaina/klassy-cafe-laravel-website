...
-->
    ...
    <link href="{{ asset('css/templatemo-klassy-cafe.css') }}" rel="stylesheet" type="text/css" >
                        ...
                        -->
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="/home">View Reservations</a></li>
                                    @auth
                        ...
                        <form id="contact" action="/reserve" method="post">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="name" type="text" id="name" placeholder="Your Name*" required="" value="{{ old('name') }}" class="@error('name') is-invalid @enderror">
                                @error('name')
                            ...
                            <div class="col-lg-6">
                                <div id="filterDate2">    
                                  <div class="input-group date" data-date-format="dd/mm/yyyy">
                                    <input  name="date" id="date" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="dd/mm/yyyy" value="{{ old('date') }}">
                                    @error('date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
    ...
    <script type="text/javascript" src="{{ asset('js/accordions.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('js/imgfix.min.js') }}"></script> 
